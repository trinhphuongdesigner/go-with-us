...
@router.get(
    "",
    response_model=RosterPageRead,
    responses={
        status.HTTP_401_UNAUTHORIZED: {"model": ErrorDetailRead},
        status.HTTP_403_FORBIDDEN: {"model": ErrorDetailRead},
        status.HTTP_404_NOT_FOUND: {"model": ErrorDetailRead},
        status.HTTP_400_BAD_REQUEST: {"model": ErrorDetailRead},
    },
)
...
@router.get(
    "/{employee_id}",
    response_model=RosterPersonDetailRead,
    responses={
        status.HTTP_401_UNAUTHORIZED: {"model": ErrorDetailRead},
        status.HTTP_403_FORBIDDEN: {"model": ErrorDetailRead},
        status.HTTP_404_NOT_FOUND: {"model": ErrorDetailRead},
