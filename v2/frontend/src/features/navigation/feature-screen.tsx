...
export function FeatureScreen({ feature, detail, forceState }: { feature: string; detail: FeatureDetail; forceState?: CoreUiForcedState }) {
  ...
  if (feature === "nhan-su") return <PeopleListView forceState={forceState} />;
