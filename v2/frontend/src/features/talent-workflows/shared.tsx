...
export type Template = { id: string; familyId: string; version: number; companyId: string; name: string; description: string; status: "DRAFT" | "ACTIVE" | "ARCHIVED"; groups: Array<{id: string; name: string; description: string; weight: number; scoreDimension: "CONTRIBUTION" | "ATTITUDE"; questions: Array<{id: string; text: string; guidance: string; weight: number; maxScore: number}>}> };
